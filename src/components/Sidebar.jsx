...
const Sidebar = () => {
  return (
    <>
      <section className='w-[20%] bg-[#4F0DA3] min-h-full md:min-h-screen'>
      <div className="h-full p-3 space-y-2">

        {/* <div className="divide-y divide-gray-700"> */}

          <ul className="flex flex-col items-center pt-2 pb-4 space-y-1 text-sm md:block">
            <li className="text-white rounded-md hover:bg-purple-300">
              <a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">

                <svg fill="#ffffff"  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="20" height="25" viewBox="0 0 32 32">
                ...
                <span className="hidden md:inline-block hover:inline-block">Home</span>
              </a>
            </li>

            <li  className='text-[#C47EFB] rounded-md hover:bg-purple-300'>
              <a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
              <svg className='w-5 h-5' viewBox="0 0 48 48" id="b" xmlns="http://www.w3.org/2000/svg" fill="#C47EFB"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"><path id="c" className="e" d="m24.9697,39.04v-3.7188c2.9742-2.9742,5.4671-3.9181,9.2651-3.9181h0c3.798,0,6.2909.9439,9.2651,3.9181v3.7188h-18.5303Z"></path><circle className="e" cx="34.2349" cy="22.8928" r="4.9752"></circle><path id="d" className="e" d="m24.9697,39.04H4.5v-6.2886c5.0295-5.0295,9.2451-6.6257,15.6678-6.6257h0c5.7656,0,9.7526,1.2863,14.1465,5.188"></path><circle className="e" cx="20.1678" cy="15.8085" r="6.8485"></circle></g></svg>
              <span className="hidden md:inline-block">Connect</span>
              </a>
            </li>
            ...
            <li className='text-[#C47EFB] rounded-md hover:bg-purple-300'>
              <a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
               <svg className='w-5 h-5' viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M6 17.45V26C6 26.2652 6.10536 26.5195 6.29289 26.7071C6.48043 26.8946 6.73478 27 7 27H25C25.2652 27 25.5196 26.8946 25.7071 26.7071C25.8946 26.5195 26 26.2652 26 26V17.45" stroke="#C47EFB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M6.75 5H25.25C25.4669 5.00179 25.6776 5.0732 25.8508 5.20373C26.0241 5.33425 26.1509 5.51698 26.2125 5.725L28 12H4L5.7875 5.725C5.84909 5.51698 5.97587 5.33425 6.14916 5.20373C6.32244 5.0732 6.53306 5.00179 6.75 5V5Z" stroke="#C47EFB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M12 12V14C12 15.0609 11.5786 16.0783 10.8284 16.8284C10.0783 17.5786 9.06087 18 8 18C6.93913 18 5.92172 17.5786 5.17157 16.8284C4.42143 16.0783 4 15.0609 4 14V12" stroke="#C47EFB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M20 12V14C20 15.0609 19.5786 16.0783 18.8284 16.8284C18.0783 17.5786 17.0609 18 16 18C14.9391 18 13.9217 17.5786 13.1716 16.8284C12.4214 16.0783 12 15.0609 12 14V12" stroke="#C47EFB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M28 12V14C28 15.0609 27.5786 16.0783 26.8284 16.8284C26.0783 17.5786 25.0609 18 24 18C22.9391 18 21.9217 17.5786 21.1716 16.8284C20.4214 16.0783 20 15.0609 20 14V12" stroke="#C47EFB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
            ...
            <li className='text-[#C47EFB] rounded-md hover:bg-purple-300'>
              <Link to="/education" className="flex items-center p-2 space-x-3 rounded-md">
            ...
            <li className='text-[#C47EFB] rounded-md hover:bg-purple-300'>
              <Link to="/business" className="flex items-center p-2 space-x-3 rounded-md">
                <svg className="w-5 h-5" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="hidden md:inline-block">Business Directory</span>
              </Link>
            </li>
            ...
            <li className='text-[#C47EFB] rounded-md hover:bg-purple-300'>
              <a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
                <svg className="w-5 h-5" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M16 28C22.6274 28 28 22.6274 28 16C28 9.37258 22.6274 4 16 4C9.37258 4 4 9.37258 4 16C4 22.6274 9.37258 28 16 28Z" stroke="#C47EFB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M16 20C18.7614 20 21 17.7614 21 15C21 12.2386 18.7614 10 16 10C13.2386 10 11 12.2386 11 15C11 17.7614 13.2386 20 16 20Z" stroke="#C47EFB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M7.9751 24.925C8.72749 23.4431 9.87555 22.1984 11.292 21.3289C12.7085 20.4595 14.3381 19.9993 16.0001 19.9993C17.6621 19.9993 19.2917 20.4595 20.7082 21.3289C22.1246 22.1984 23.2727 23.4431 24.0251 24.925" stroke="#C47EFB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
            ...
            <li className='text-[#C47EFB] rounded-md hover:bg-purple-300'>
              ...
              <svg className="w-5 h-5" viewBox="0 0 32 32" fill="#C47EFB" xmlns="http://www.w3.org/2000/svg">
                  <path d="M19.9993 20.3333C21.9993 20.3333 23.3327 21.5867 23.3327 23H27.3327V3H23.3327C23.3327 4.33333 21.9993 5.66667 19.9993 5.66667C17.9993 5.66667 16.666 4.33333 16.666 3H12.666V12.3333" stroke="white" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
            ...
            <li className='text-[#C47EFB] rounded-md hover:bg-purple-300'>
              <a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
              <svg className="w-5 h-5" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M8 28.0001C10.2091 28.0001 12 26.2092 12 24.0001C12 21.7909 10.2091 20.0001 8 20.0001C5.79086 20.0001 4 21.7909 4 24.0001C4 26.2092 5.79086 28.0001 8 28.0001Z" fill="#C47EFB" stroke="#C47EFB" strokeWidth="2.66667" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M24 26.668C26.2091 26.668 28 24.8772 28 22.668C28 20.4589 26.2091 18.668 24 18.668C21.7909 18.668 20 20.4589 20 22.668C20 24.8772 21.7909 26.668 24 26.668Z" fill="#C47EFB" stroke="#C47EFB" strokeWidth="2.66667" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M28 4.00006L12 8.00006V13.3334L28 9.33339V4.00006Z" fill="#C47EFB"/>
                <path d="M12 24.0001V13.3334M12 13.3334V8.00006L28 4.00006V9.33339M12 13.3334L28 9.33339M28 22.6667V9.33339" stroke="#C47EFB" strokeWidth="2.66667" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>

                <span className="hidden md:inline-block">Stereo</span>
              </a>
            </li>
            ...
            <li className='text-[#C47EFB] rounded-md hover:bg-purple-300'>
              ...
              <svg className="w-5 h-5" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="hidden md:inline-block">TV</span>
              </a>
            </li>
            ...
            <li className='text-[#C47EFB] rounded-md hover:bg-purple-300'>
              ...
              <svg className="w-5 h-5" viewBox="0 0 32 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="hidden md:inline-block">Voting</span>
              </a>
            </li>

          </ul>

          <ul className="flex flex-col items-center pt-4 pb-2 space-y-1 text-sm md:block">
            <li className='text-[#C47EFB] hover:bg-purple-300'>
              <a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-400">
            ...
            <li className='text-white hover:bg-purple-300'>
              <a rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-5 h-5 fill-current dark:text-gray-400">
